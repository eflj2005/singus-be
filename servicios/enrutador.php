<?php
    ...
    //$enrutador->AgregarRecurso("obtener_registros","GET","recursos/generales/consultar_tabla.php");
    $enrutador->AgregarRecurso("crear_registros","POST","recursos/generales/insertar_registros.php");
